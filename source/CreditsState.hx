...
class CreditsState extends MusicBeatState
{
	...
	private static var wholeAssCreditList:Array<Dynamic> = [ // LAYOUT: Name, Icon name, "Quote"\nDescription, Link
		...
		[''],
		['Extra Charters'],
		['dude0216', 			'dude0216', 		'"fefe"\nCultured Hard difficulty rechart', 											'https://www.youtube.com/channel/UCiGJubAsma0AWVozQUIoCJA'],
		['Cerbera', 			'cerbera', 			'"swag"\ncharted Cultured EX difficulty, & Mozzarella Easy & Hard difficulty',			'https://www.youtube.com/c/Cerberaa'],
		[''],
		['Voice Actors'],
