...
class NoteDad extends FlxSprite
{
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:NoteDad, ?sustainNote:Bool = false, ?inEditor:Bool = false)
	{
		super();
		...
		switch (daStage)
		{
			...
			default:
				frames = Paths.getSparrowAtlas('NOTES_BLUECHEESE');
				loadNoteAnims();
